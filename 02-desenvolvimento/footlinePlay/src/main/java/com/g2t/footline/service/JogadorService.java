...
public class JogadorService {
	 ...
	 * 	A lista deve ordenar, em ordem descrecente,
	 *  os jogadores com a maior quantidade de gols.
	 *  
	 * @param Footline footline
	 * @return List<Jogador>
	 */
	public List<Jogador> retornaListaArtilheiros(Footline footline) {
		// TODO: 004 - implementar a lista de artilheiros
