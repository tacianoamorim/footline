 ...
 * contendo a descri��o de partidas do campeonato.
 * 
...
public class LeitorPartidas
{
	...
	public LeitorPartidas(String fileName)
	{
		...
		try {
			in = new BufferedReader(new FileReader(fileName));
			 ...
			 System.out.println("LeitorPartidas: arquivo n�o encontrado!");
			 return;
		}
	...
	/**
     * L� o pr�ximo registro do arquivo de partidas.
     * 
	...
	public Partida proximaPartida()
	{
		...
		try 
		{
			...
			if(token != StreamTokenizer.TT_WORD) {
				System.out.println("LeitorPartidas.proximaPartida: defini��o incorreta do mandante");
			...
			if(token != StreamTokenizer.TT_NUMBER) {
				System.out.println("LeitorPartidas.proximaPartida: defini��o incorreta dos gols (mandante)");
				throw new IOException();
			}
			...
			if(token != StreamTokenizer.TT_NUMBER) {
				System.out.println("LeitorPartidas.proximaPartida: defini��o incorreta dos gols (visit.)");
				throw new IOException();
			}
			...
			if(token != StreamTokenizer.TT_WORD) {
				System.out.println("LeitorPartidas.proximaPartida: defini��o incorreta do visitante");
				throw new IOException();
			}
